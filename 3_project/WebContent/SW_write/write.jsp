...
<div id="main">
	...
	<form method="post" action="${cp }/SW_write/write">
		 ...
		 <tr><th align="center">글쓴이</th><td><input type="text" name="mid "placeholder="아이디를 적어주세요." required autofocus></td></tr>
     	 <tr height="1" bgcolor="#dddddd"><td colspan="2"></td></tr>
		 <tr><th align="center">제목</th><td><input type="text" name="title "  placeholder="제목을 적어주세요." required></td></tr>
		 <tr height="1" bgcolor="#dddddd"><td colspan="2"></td></tr>
		 <tr><th align="center">내용</th><td><textarea rows="5" cols="60" name="writecontent" placeholder="내용을 적어주세요." required></textarea></td></tr>
		 <tr height="1" bgcolor="#dddddd"><td colspan="2"></td></tr>
