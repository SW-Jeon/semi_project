	...
	<form method="post" action="${cp }/SW_review/Rwrite" enctype="multipart/form-data">
		 <table  style="width:40%" >
			 <tr>
			 	...
			 	<td><input type="text" name="qaname" placeholder="이름을 적어주세요." required autofocus></td>
			 </tr>
	     	 <tr height="1" bgcolor="#dddddd"><td colspan="2"></td></tr>
	     	 
			 <tr>
			 	<th align="center">제목</th>
			 	<td><input type="text" name="astitle" placeholder="제목을 적어주세요." required></td>
			 </tr>
			 <tr height="1" bgcolor="#dddddd"><td colspan="2"></td></tr>
			 
			 <tr>
			 	<th align="center">후기</th>
			 	<td><textarea rows="5" cols="60" name="ascontent" placeholder="후기를 남겨주세요.(33자이내)" required></textarea></td>
			 </tr>
			 <tr height="1" bgcolor="#dddddd"><td colspan="2"></td></tr>
