...
<!--  /SH.acc_insert/neckInsertform.jsp -->
<div id="main">
	<h1 style="font-size: 4em; text-align:center; ">상품등록페이지</h1>
	<form action="${cp }/SH.acc_insert/braceinsertOk.jsp" enctype="multipart/form-data" method="post">
			 ...
			 <tr>
				<th style="font-size: 1.5em;  font-weight:bold; text-align:center; padding-left: 5px; width: 20%; ">코드번호</th>
			 	<td><input type="text" name="gocode" style="width: 90%; height: 50px; font-size: large;" placeholder="목걸이n" required autofocus ></td>
			 </tr>
			  <tr>
			 ...
			 <tr>
			  ...
			  <tr>
				<th style="font-size: 1.5em;  font-weight:bold; text-align:center; padding-left: 5px; width: 20%; ">품목번호</th>
			 	<td><input type="text" name="jnum" style="width: 90%; height: 50px; font-size: large;" placeholder="목걸이200" required ></td>
			 </tr>
		</table>
