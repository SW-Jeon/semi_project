...
<body>
<%
String saveDirectory="C:\\Users\\JHTA\\Desktop\\세미\\3_project\\3_project\\WebContent\\acc\\watch";
...
if(n>0){
	...
	response.sendRedirect(request.getContextPath()+"/SH.acc_insert/watchinsertform.jsp");
}
