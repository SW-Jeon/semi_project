...
<body>
<%
String saveDirectory="C:\\Users\\JHTA\\Desktop\\세미\\3_project\\3_project\\WebContent\\acc\\neck";
...
if(n>0){
	...
	response.sendRedirect(request.getContextPath()+"/SH.acc_insert/neckinsertform.jsp");
}
