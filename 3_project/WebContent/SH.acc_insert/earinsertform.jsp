...
<meta charset="UTF-8">
<title>/SH.acc_insert/earInsertform.jsp</title>
</head>
<body>
<form action="${cp }/SH.acc_insert/earinsertOk.jsp" enctype="multipart/form-data" method="post">
		<h1>상품등록페이지</h1>
		코드번호<br>
		<input type="text" name="gocode"  placeholder="귀걸이e" class="gocode"><br>
		제품이름 <br>
		...
		품목번호<br>
		<input type="text" name="jnum" placeholder="귀걸이100"  class="jnum"><br>	
