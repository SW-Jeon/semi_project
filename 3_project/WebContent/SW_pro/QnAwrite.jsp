	...
	<form method="post" action="${cp }/SW_pro/QnAwrite">
		 <table  style="width:100%" >
			 ...
			 <tr>
			 	...
			 	<td><textarea rows="5" cols="60" name="qacontent" placeholder="내용을 적어주세요." required></textarea></td>
			 </tr>
			 <tr height="1" bgcolor="#dddddd"><td colspan="2"></td></tr>
			 
			 <tr>
			 	<th align="center">비밀번호</th>
				<td><input type="password" name="qapwd" placeholder="비밀번호를 입력해주세요." required></td>
			 </tr>
			 <tr height="1" bgcolor="#dddddd"><td colspan="2"></td></tr>
